  ...
  data() {
    return {
      ...
      markDate: [
        ...
        { color: '#b7bc1f', text: '放假了真高兴', type: 'bottomText', date: ['2020/01/29', '2020/02/29', '2020/03/29', '2020/04/29', '2020/05/29', '2020/06/29', '2020/07/29', '2020/08/29', '2020/09/29', '2020/10/29', '2020/11/29', '2020/12/29'] }
